...
const TRANSLATIONS = {
  fr: {
    ...
    'skin.appliedOfflineNote': "Skin appliqué (aperçu local uniquement — les autres joueurs ne le verront pas en jeu sans compte Microsoft ou LittleSkin).",
    'skin.appliedLittleskinManual': "Fichier prêt dans Téléchargements — termine l'envoi dans la page LittleSkin qui vient de s'ouvrir.",
    'skin.error': 'Erreur : {{message}}',

    'skin.littleskinTitle': 'Skin visible en crack',
    'skin.littleskinHint': "Prends un skin déjà fait sur LittleSkin, ou termine l'envoi du tien en 2-3 clics (ton pseudo LittleSkin doit être le même qu'en jeu).",
    'skin.littleskinOverlayTitle': 'LittleSkin',
    'skin.littleskinOpen': 'Parcourir LittleSkin',
    'skin.littleskinCloset': 'Mon closet',
    'skin.modePremium': 'Premium',
    'skin.modeCrack': 'Crack',
    ...
    'settings.graphics': 'Preset graphique Minecraft',
    'settings.maxFps': 'FPS max',
    'settings.maxFpsUnlimited': 'Illimité',
    'graphics.custom': 'Perso',
    'graphics.customDetail': 'ne rien changer',
    'graphics.extraLow': 'Extra low',
    'graphics.low': 'Low',
    'graphics.medium': 'Medium',
    'graphics.epic': 'Epic',
    'graphics.realistic': 'Réaliste',
    ...
    'server.clearModsDone': 'Fait — clique sur « Vérifier les mises à jour » pour les retélécharger.',
    'server.syncMods': 'Vérifier les mises à jour du modpack',
    'server.syncModsRunning': 'Synchronisation…',
    'server.syncModsDone': 'Fait — {{count}} fichier(s) mis à jour.',
    'server.syncModsError': 'Erreur : {{error}}',
  ...
  en: {
    ...
    'skin.appliedOfflineNote': "Skin applied (local preview only — other players won't see it in-game without a Microsoft or LittleSkin account).",
    'skin.appliedLittleskinManual': 'File ready in Downloads — finish the upload on the LittleSkin page that just opened.',
    'skin.error': 'Error: {{message}}',

    'skin.littleskinTitle': 'Cracked skin visibility',
    'skin.littleskinHint': "Grab a skin already made on LittleSkin, or finish uploading yours in 2-3 clicks (your LittleSkin username must match your in-game one).",
    'skin.littleskinOverlayTitle': 'LittleSkin',
    'skin.littleskinOpen': 'Browse LittleSkin',
    'skin.littleskinCloset': 'My closet',
    'skin.modePremium': 'Premium',
    'skin.modeCrack': 'Cracked',
    ...
    'settings.graphics': 'Minecraft graphics preset',
    'settings.maxFps': 'Max FPS',
    'settings.maxFpsUnlimited': 'Unlimited',
    'graphics.custom': 'Custom',
    'graphics.customDetail': 'leave untouched',
    'graphics.extraLow': 'Extra low',
    'graphics.low': 'Low',
    'graphics.medium': 'Medium',
    'graphics.epic': 'Epic',
    'graphics.realistic': 'Realistic',
    ...
    'server.clearModsDone': 'Done — click "Check for updates" to re-download them.',
    'server.syncMods': 'Check for modpack updates',
    'server.syncModsRunning': 'Syncing…',
    'server.syncModsDone': 'Done — {{count}} file(s) updated.',
    'server.syncModsError': 'Error: {{error}}',
